...
def calcular_tiempo_total_por_archivo(df: pd.DataFrame) -> timedelta:
    ...
    usando siempre Fecha + Hora y agrupando por 'Nombre Archivo' como en la lógica original.
    """
    total = timedelta(0)
...
with st.expander("🖨️ Generar informe PDF / Word", expanded=False):
    ...
    if not st.session_state["tabla_maestra"].empty:
        ...
        # - si hay localidad seleccionada -> df_localidad
        # - si no, el filtro de CCTE/provincia/año -> df_filtrado_prov
